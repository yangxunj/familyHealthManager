...
### 步骤 7：UI 适老化优化（通过"老人模式"实现）✅

1. [x] **老人模式 Store**：Zustand + localStorage 持久化，`data-elder-mode` HTML 属性
2. [x] **Ant Design 主题覆盖**：fontSize 17px、Button/Input controlHeight 52px、Menu itemHeight 52px
3. [x] **CSS 全局覆盖**：font-size 17px、line-height 1.8、ant-tag/anticon/ant-btn 放大
4. [x] **MainLayout 菜单过滤**：老人模式隐藏复杂菜单（成员管理、文档、健康计划、家庭设置）
5. [x] **顶栏快捷切换**：EyeOutlined 图标按钮，激活时蓝色高亮
6. [x] **ElderDashboard**：2x2 大卡片（健康咨询、健康建议、记录数据、我的记录）
7. [x] **Settings 显示设置 Tab**：老人模式开关 + 功能说明
